...
```
  ...
  The multivariate meta-analysis model above there were 801 samples involved in this analysis. The test for residual heterogeneity presents that the p value < 0.001 was low indicating that it was significant that the studies were not equal and that the diversity between the variables was detected. The p value for the moderators was 0.3758 suggests that the interactions between the moderating variables.         
